...
/**
 * Flywheel visual for the Mechanical Sieve.
 * <ul>
 *   <li>The shaft model now also contains the wooden cam extensions, so it just spins via
 *       {@link SingleAxisRotatingVisual}.</li>
 *   <li>The net (with its metal anchors) is oriented to the block facing once, then translated
 *       each frame perpendicular to the shaft axis by {@code amplitude * sin(shaftAngle)}.</li>
 * </ul>
 */
